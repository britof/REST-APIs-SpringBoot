package com.example.persistence_api.controllers;
...
import com.example.persistence_api.services.SubjectService;
...
public class SubjectController {
    ...
    public ResponseEntity<Subject> getSubjectById(@RequestParam(value="id") Integer id) {
        Subject subject = subjectService.getSubjectById(id).get();
        if(subject == null)
